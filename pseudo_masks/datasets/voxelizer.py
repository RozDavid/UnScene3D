    ...
    def voxelize(self, coords, feats, center=None, augment=True):
        ...
        if self.clip_bound is not None:
            ...
            if clip_inds is not None:
                ...
                voxelized_inds = voxelized_inds[clip_inds]
        ...
        return coords_aug[unique_map], feats[unique_map], voxelized_inds[unique_map], (M_v, M_r)
